    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idDd', models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='doctord', to=settings.AUTH_USER_MODEL, verbose_name='Usuario doctor')),
